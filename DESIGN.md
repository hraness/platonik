...
Homepage display and section sizes use the marketing clamps in frontmatter; supporting copy is 17px with 1.6 leading, becoming 16px on narrow screens. Document title and prose roles preserve the reading site's sizes. At widths up to 480px, body text becomes 16px, prose 16px, document title 38px, and prose section headings 27px. Laboratory and world introductions use 16px supporting copy; instrument notes, captions, and messages keep the 14px control role, while labels, observed values, and option descriptions stay compact.
