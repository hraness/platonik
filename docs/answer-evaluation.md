...
| Ambition and submitted candidate | Training answers | Training work | Canonical program bytes |
| --- | --- | --- | --- |
| Keep: live-echo | 4 / 4 | 88,045 | 5,409 |
| Keep: direct-echo | 4 / 4 | 86,452 | 5,312 |
| Keep: **rested-builder**, selected | 4 / 4 | 83,124 | 5,253 |
| Frugal: quiet-workshop | 4 / 4 | 83,593 | 5,186 |
| Frugal: late-compass-setup | 4 / 4 | 80,185 | 5,050 |
| Frugal: **compact-detours**, selected | 4 / 4 | 77,367 | 4,356 |
...
| Shared comparison | Service successes | Constructed journey answers | Total modeled work |
| --- | --- | --- | --- |
| Supplied reference | 8 / 8 | 8 / 8 | 178,736 |
| Direct forwarding | 8 / 8 | 8 / 8 | 173,800 |
| Initially installed children | 8 / 8 | 0 / 8 | 148,326 |
...
| Reference world | Run, verify, grade, serialize p50 / p95 | Including extra identity checks p50 / p95 | Receipt bytes |
| --- | --- | --- | --- |
| answer-one | 14.23 / 14.97 ms | 18.56 / 19.19 ms | 678,345 |
| answer-crossing | 13.41 / 13.95 ms | 17.54 / 18.34 ms | 682,215 |
...
The [frozen protocol](https://github.com/hraness/platonik/blob/main/fixtures/evidence/answer-protocol.json), [complete study ledger](https://github.com/hraness/platonik/blob/main/fixtures/evidence/answer-study.json), and [capacity samples](https://github.com/hraness/platonik/blob/main/fixtures/evidence/answer-capacity.json) retain the declared allowances, exact inputs, candidate selection, process metrics, failures, and artifact identities. The [recorded journey](https://platonik.space/lab/answer) offers four receipts and their save bundles, including an unsuccessful old-report control.
...
Those gates remain before [human playtesting](design-validation.md#the-automated-path-before-people-play). Reachability and reproducibility cannot establish attachment, pacing, or enjoyment. Improvements on these supplied worlds are computational results about these worlds; scientific novelty and claims about P versus NP require separate research questions and evidence.
