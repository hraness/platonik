...
A fresh [generated-courier exchange](composition-v5-gate.md) now connects variation to a real request and a child-origin acknowledgment in six v4 worlds. It adapts the seed and local controllers, with its own grade, controls, and immutable receipts. The earlier v3 two-lane Ports contract remains separate; capacity, agent search, and the complete campaign still need their own evidence.
