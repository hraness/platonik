...
3. Preserve that file. Apply one bounded command to a new file: advance 1–128 ticks, change one admitted creature program, place a fabricator, storehouse, assembler, or crane site on an open tile or a drill on a material deposit, or name a facility — then advance so I can watch the consequence. Explain what physically changed in plain language rather than leading with hashes or metrics.
